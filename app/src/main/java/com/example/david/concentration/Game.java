    ...
    public void onActivityCreated(Bundle savedInstanceState) {
        ...
        ((Button) getActivity().findViewById(R.id.button1)).setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (correct.indexOf(firstIndex) == -1)
                    cardArray[firstIndex].setImageResource(R.drawable.back);
                if (correct.indexOf(secondIndex) == -1)
                    cardArray[secondIndex].setImageResource(R.drawable.back);
