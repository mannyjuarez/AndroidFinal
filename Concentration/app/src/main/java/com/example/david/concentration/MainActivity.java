...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //Changing the color of the 2nd player
    ...
    private void doStuff(ImageView iv, int card){
        ...
        if(cardsArray[card] == 101) iv.setImageResource(image101);
        else if(cardsArray[card] == 102) iv.setImageResource(image102);
        else if(cardsArray[card] == 103) iv.setImageResource(image103);
        else if(cardsArray[card] == 104) iv.setImageResource(image104);
        else if(cardsArray[card] == 105) iv.setImageResource(image105);
        else if(cardsArray[card] == 106) iv.setImageResource(image106);
        else if(cardsArray[card] == 201) iv.setImageResource(image201);
        else if(cardsArray[card] == 202) iv.setImageResource(image202);
        else if(cardsArray[card] == 203) iv.setImageResource(image203);
        else if(cardsArray[card] == 204) iv.setImageResource(image204);
        else if(cardsArray[card] == 205) iv.setImageResource(image205);
        else if(cardsArray[card] == 206) iv.setImageResource(image206);
    ...
    private void frontOfCardsResources(){
        image101 = R.drawable.beaver;
        image102 = R.drawable.giraffe_1;
        image103 = R.drawable.goat_1;
        image104 = R.drawable.hippo_1;
        image105 = R.drawable.owl_1;
        image106 = R.drawable.peacock_1;
        image201 = R.drawable.beaver_2;
        image202 = R.drawable.giraffe_2;
        image203 = R.drawable.goat_2;
        image204 = R.drawable.hippo_2;
        image205 = R.drawable.owl_2;
        image206 = R.drawable.peacock_1;
